<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConcesionarioMarca.aspx.cs" Inherits="CONCESIONARIO_PROYECTO.ConcesionarioMarca" %>
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark text-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#">
                <img src="Imgs\Quaxly.png" alt="Logo" width="35" height="30" class="" />
            </a>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid ">
            <p></p>
            <a class="btn btn-outline-dark m-3" href="/InsertConcesionarioMarca">
  ...
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
            ...
            <asp:GridView class="table table-dark table-hover table-striped" ID="concesionarioTabla" runat="server" OnRowCommand="concesionarioTabla_RowCommand" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:BoundField DataField="anno_creacion" HeaderText=" Año Fundacion" DataFormatString="{0:dd/MM/yyyy}" />
                    <asp:ButtonField ButtonType="Button" CommandName="editVehiculoMarca" Text="Edit" HeaderText="">
                        <ControlStyle CssClass="btn btn-primary" />
                    </asp:ButtonField>
                    <asp:ButtonField ButtonType="Button" CommandName="deleteVehiculoMarca" Text="Delete" HeaderText="">
