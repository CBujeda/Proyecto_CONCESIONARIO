                        ...
                        <div class="col">
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    ...
                                    <asp:TextBox ID="motor" class="form-control" runat="server"></asp:TextBox>

                                    <label class="form-label">Nombre Marca</label>
                                    <asp:TextBox ID="nombreMarca" class="form-control" runat="server"></asp:TextBox>

                                    <label class="form-label">Pais</label>
                                    <asp:TextBox ID="pais" class="form-control" runat="server"></asp:TextBox>

                                    <label class="form-label">Año</label>
                                    <asp:TextBox ID="anno" class="form-control" runat="server"></asp:TextBox>

                                    <asp:Button ID="newActualizar" class="btn btn-outline-secondary mt-2" runat="server" Text="Crear" />
                                </div>
                            </div>
                        </div>
                    </div>
